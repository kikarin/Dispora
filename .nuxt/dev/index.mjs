...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file:///var/www/Dispora/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///var/www/Dispora/node_modules/@vue/shared/dist/shared.cjs.js';
...
import unstorage_47drivers_47fs from 'file:///var/www/Dispora/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///var/www/Dispora/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///var/www/Dispora/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///var/www/Dispora/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///var/www/Dispora/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///var/www/Dispora/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///var/www/Dispora/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///var/www/Dispora/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///var/www/Dispora/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///var/www/Dispora/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///var/www/Dispora/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///var/www/Dispora/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///var/www/Dispora/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///var/www/Dispora/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///var/www/Dispora/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///var/www/Dispora/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///var/www/Dispora/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///var/www/Dispora/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/var/www/Dispora/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/var/www/Dispora","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/var/www/Dispora/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/var/www/Dispora/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/var/www/Dispora/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/var/www/Dispora/.data/kv"}));
...
const _EwrVEds7BDCQO2pnidww6W3GXNtMoAVwRzQoJgNyg = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/var/www/Dispora";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"},{"charset":"utf-8"},{"name":"mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-status-bar-style","content":"default"}],"link":[],"style":[],"script":[],"noscript":[],"viewport":"width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"};
...
const _0A070CpV6VNYCtTbUrmm75FJPRYQiXonzcOg7slScQ = (nitroApp) => {
...
const _3S3cMB = eventHandler((event) => {
...
const getServerEntry = () => import('file:///var/www/Dispora/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///var/www/Dispora/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_w4JL9B = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _3S3cMB, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_w4JL9B, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_w4JL9B, lazy: true, middleware: false, method: undefined }
];
