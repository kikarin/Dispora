          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input 
                ...
                type="email" 
                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#597BF9] focus:border-transparent"
            ...
            <div>
              ...
              <div class="relative">
                <input 
                  ...
                  class="w-full px-4 py-3 pr-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#597BF9] focus:border-transparent"
