      ...
      <div class="bg-white/90 rounded-2xl p-6 shadow-sm backdrop-blur">
        ...
        <div class="space-y-4">
          ...
          <button
            ...
            :disabled="settingsLoading"
            class="w-full bg-gray-800 text-white py-3 px-4 rounded-xl font-medium hover:bg-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <span v-if="settingsLoading">Loading...</span>
...
const handleUpdateProfile = async () => {
  ...
  try {
    ...
    const response = await $fetch<{
      ...
      baseURL: 'https://dispora.summitbreak.com//api',
      method: 'PUT',
