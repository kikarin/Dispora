<template>
  <PageLayout>
    ...
    <div class="mb-6 space-y-4">
      ...
      <div class="relative">
        <div
          class="flex items-center gap-2 rounded-2xl bg-white/80 p-3 shadow-sm backdrop-blur"
        >
          <svg
    ...
    <!-- Turnamen List -->
    <div v-else-if="filteredTurnamen.length > 0" class="space-y-6">
      <div
            ...
            <div v-if="canManageTurnamen" class="relative">
              ...
              >
                <div class="py-2">
                  ...
                  <button
                    @click="() => handleDeleteClick(turnamen.id, turnamen.nama)"
    ...
    <div v-else-if="!loading" class="text-center py-12">
      ...
      <h3 class="text-lg font-medium text-gray-900 mb-2">Tidak ada turnamen</h3>
