        ...
        <div class="flex items-start gap-3">
          ...
          <div class="flex-shrink-0 mt-1">
            ...
            >
              ...
              >
                <path
                  v-if="notification.type === 'program'"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  d="M13 10V3L4 14h7v7l9-11h-7z"
                />
                <path
                  v-else-if="notification.type === 'pemeriksaan'"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"
                />
                <path
                  v-else-if="notification.type === 'turnamen'"
                  stroke-linecap="round"
                  stroke-linejoin="round"
          ...
          <div class="flex-1 min-w-0">
            <h4 class="font-semibold text-gray-700 text-sm mb-1 line-clamp-2">
              {{ notification.title }}
            </h4>
      ...
      >
        ...
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
            d="M15 17h5l-5 5v-5zM4.5 9.5a5 5 0 0110 0v1.5a2 2 0 002 2h2a2 2 0 002-2V9.5a5 5 0 01-10 0v-1.5a2 2 0 00-2-2h-2a2 2 0 00-2 2v1.5z"
          />
        </svg>
      </div>
...
const notifications = ref([
  {
    ...
    message:
      'Program latihan "Basket Elite Training" telah ditambahkan untuk bulan Agustus 2025',
  ...
  },
  {
    ...
    message:
      'Pemeriksaan fisik untuk tim basket dijadwalkan ulang pada 20 Agustus 2025',
  ...
  },
  {
    ...
    message:
      'Pendaftaran untuk "Kejuaraan Basket 3x3 Indonesia Open" telah dibuka',
